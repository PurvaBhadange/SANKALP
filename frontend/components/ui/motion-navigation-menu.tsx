...
function MotionNavigationMenuList({
  ...
  return (
    <Highlight
      ...
      hover
      className={cn(
        "bg-[#25463c] rounded-md pointer-events-none",
        highlightClassName,
      )}
      style={{ zIndex: -1 }}
...
const motionNavigationMenuTriggerStyle = cva(
  "group inline-flex h-9 w-max items-center justify-center rounded-md bg-transparent px-3 py-2 text-xs font-semibold text-emerald-100 hover:text-white focus:text-white disabled:pointer-events-none disabled:opacity-50 data-[state=open]:text-white focus-visible:ring-ring/50 outline-none transition-colors",
);
    ...
    <HighlightItem asChild>
      ...
      >
        ...
        <motion.span
          ...
          className="relative top-0 ml-1.5 inline-flex text-emerald-300"
        >
    ...
    <AnimatePresence initial={false} custom={context.direction}>
      {isOpen && (
        <motion.div
          ...
          className={cn(
            "bg-white text-slate-900 absolute top-full left-0 z-50 mt-1.5 rounded-xl border border-slate-200 p-2 pr-2.5 shadow-xl",
            className,
          )}
        >
...
function MotionNavigationMenuContentInner({
  ...
  return (
    <Highlight
      ...
      hover
      className={cn(
        "bg-slate-100 rounded-lg pointer-events-none",
        highlightClassName,
      )}
      style={{ zIndex: -1 }}
      containerClassName="relative"
  ...
  return (
    ...
    >
      <motion.div
        ...
        transition={context?.spring}
        className={cn(
          "bg-white text-slate-900 relative mt-1.5 overflow-hidden rounded-2xl border border-slate-200 shadow-2xl backdrop-blur-md",
          className,
        )}
      >
        <AnimatePresence
        ...
        >
          {activeContent && context?.activeValue && (
            <motion.div
              ...
              exit="exit"
              transition={context.spring}
              className={cn("p-3", activeContent.className)}
            >
              <MotionNavigationMenuContentInner
      ...
      >
        {activeContent && (
          <div className={cn("p-3", activeContent.className)}>
            <MotionNavigationMenuContentInner
              highlightClassName={activeContent.highlightClassName}
              innerClassName={activeContent.innerClassName}
            >
  ...
  return (
    <HighlightItem asChild>
      <a
        ...
        className={cn(
          "data-[active=true]:text-slate-900 hover:text-slate-900 focus:text-slate-900 focus-visible:ring-ring/50 flex flex-col gap-1 rounded-lg p-2.5 text-xs font-semibold text-slate-700 transition-colors outline-none",
          className,
        )}
        {...props}
      />
...
function MotionNavigationMenuIndicator({
  ...
  return (
    <div
      ...
      {...props}
    >
      <div className="bg-slate-200 relative top-[60%] h-2 w-2 rotate-45 rounded-tl-sm shadow-md" />
    </div>
  );
}
